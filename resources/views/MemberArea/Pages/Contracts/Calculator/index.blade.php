...
@section('title', 'Production Calculator | SOP')
@section('header')
<div class="row  py-4">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div class="col-lg-6 col-7">
                <h6 class="h2 text-dark d-inline-block mb-0">Production Calculator </h6>
                <nav aria-label="breadcrumb" class="d-none d-md-block mt-2">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Production Calculator</li>
                    </ol>
                </nav>
            </div>
        </div>
